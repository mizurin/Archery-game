...
public class TargetUD : MonoBehaviour
{
    ...
    void Update()
    {
        if (killed == false)
        {
            this.transform.position = new Vector3(neutral.position.x, neutral.position.y + Mathf.Sin(Time.time)/30f, neutral.position.z);
